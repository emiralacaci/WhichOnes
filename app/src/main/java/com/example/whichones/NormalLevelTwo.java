...
public class NormalLevelTwo extends AppCompatActivity {
    Animation animation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_level_two);
 ...
 */
    ...
    public void control(View view){
        ...
        if(isWin){
            ...
            if(time<=5000 && time>2000){
                ...
                database.execSQL("UPDATE levels SET levelpermission ='yes' WHERE level='hardlevelone'");
            }
        }
    ...
    public void goMainPage(View view){
        Intent intent=new Intent(NormalLevelTwo.this,MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
    }

    public void setStatusBarColor(){
        Window window = NormalLevelTwo.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(NormalLevelTwo.this, R.color.normal));
    }
}