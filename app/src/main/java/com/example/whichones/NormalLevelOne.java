...
public class NormalLevelOne extends AppCompatActivity {
    Animation animation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_normal_level_one);
 ...
 */
    ...
    public void control(View view){
        ...
        if(isWin){
            ...
            if(time<=5000 && time>2000){
                ...
                database.execSQL("UPDATE levels SET levelpermission ='yes' WHERE level='normalleveltwo'");
            }
        }
    ...
    public void goMainPage(View view){
        Intent intent=new Intent(NormalLevelOne.this,MainActivity.class);
    ...
    public void setStatusBarColor(){
        Window window = NormalLevelOne.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(NormalLevelOne.this, R.color.normal));
    }
